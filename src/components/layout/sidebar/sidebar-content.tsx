    ...
    <div className="sidebar-content px-4 py-6">
      <ul className="flex flex-col w-full">
        <li className="my-px">
          <a
            href="#"
            className="flex flex-row items-center h-10 px-3 rounded-lg text-gray-600 bg-gray-100"
          >
        ...
        <li className="my-px">
          <a
            href="#"
            className="flex flex-row items-center h-10 px-3 rounded-lg text-gray-400 hover:bg-gray-700"
          >
        ...
        <li className="my-px">
          ...
          >
            ...
            <span className="ml-3">Job offers</span>
          </a>
        </li>
        <li className="my-px">
          <a
          ...
          >
            ...
            <span className="ml-3">Trainings</span>
